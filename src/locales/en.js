export default {
  ...
  repo: 'You can find the source code at the Github repository.',
  ...
  reservationDesc: `<p>
      You are searching for books and can add them to the shopping cart. At
      the reservation page you can add all books from the shopping cart to a
      reservation. You can also save a collection date and notes, although all
      details are optional. If you just want to set a collection date, go
      directly to the reservation page and set a date.
    </p>
    <p>
      The records are tied to a branch and can only be viewed by that
      branch. Only admins are allowed to delete a reservation - all books must
      be marked as sold or removed.
    </p>
    <p>
      A book can be removed from the reservation by opening the book for
      editing and removing the tick in front of "Reserved".
    </p>`,
}
